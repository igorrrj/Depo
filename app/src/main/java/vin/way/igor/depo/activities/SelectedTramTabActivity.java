...
public class SelectedTramTabActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vin.way.igor.depo.R.layout.selected_tram_tab_layout);
        ...
        getSupportActionBar().setTitle("Трамвай");
        openLoadingDialog();
        ...
        Log.e("BundleSelected",number_name+"|"+f_name);
    ...
    public void onBackPressed() {
        ...
        if(ans && !rout.equals(""))
        {
            likedSQLite.Add_Item(f_name,l_name,"tram",number_name,rout,
                    begin_time,end_time,from_depo,
                    to_depo,time_interval);
        }
        else {
            likedSQLite.Delete_Item(number_name,"tram");
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        LikedSQLite likedSQLite= new LikedSQLite(this);
        if (likedSQLite.isLiked(number_name,"tram")) ans=true;
        if (ans) mFav.setIcon(vin.way.igor.depo.R.drawable.ic_favorite_black_24dp);
        Log.e("SElectedLikeTram",likedSQLite.isLiked(number_name,"tram")+"");
    ...
    class TramRouteTask extends AsyncTask<String,Void,Void> {
        @Override
    ...
    private void sendRequest(){
        StringRequest stringRequest=new StringRequest("https://depocom.000webhostapp.com/tram_routs.php", new Response.Listener<String>() {
            @Override
