...
public class TransportForStops  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(vin.way.igor.depo.R.layout.transport_for_stops,container, false);
        ...
        stop_nameTextView=(TextView)rootView.findViewById(vin.way.igor.depo.R.id.stop_name);
