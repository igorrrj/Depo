...
public class SelectedBusTabActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selected_bus_tab_layout);
        ...
        getSupportActionBar().setTitle("Автобус");
        openLoadingDialog();
    ...
    public void onBackPressed() {
        ...
        if(ans && !rout.equals(""))
        {
            likedSQLite.Add_Item(f_name,l_name,"bus",number_name,rout,
                    begin_time,end_time,from_depo,
                    to_depo,time_interval);
        }
        else {
            likedSQLite.Delete_Item(number_name,"bus");
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        LikedSQLite likedSQLite= new LikedSQLite(this);
        if (likedSQLite.isLiked(number_name,"bus")) ans=true;
        if (ans) mFav.setIcon(R.drawable.ic_favorite_black_24dp);
        Log.e("SElectedLikeBus",likedSQLite.isLiked(number_name,"bus")+"");
