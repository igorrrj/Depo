...
public class PopupTaxiAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View listViewItem = inflater.inflate(vin.way.igor.depo.R.layout.item_pop_up_taxi_numbers, parent, false);
        final TextView textViewNumber;
        textViewNumber = (TextView) listViewItem.findViewById(vin.way.igor.depo.R.id.taxi_number);
