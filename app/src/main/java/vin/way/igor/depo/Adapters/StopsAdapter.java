...
public class StopsAdapter extends BaseAdapter implements SectionIndexer{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View listViewItem = inflater.inflate(vin.way.igor.depo.R.layout.item_stops, parent, false);
        final TextView textViewName;
        textViewName = (TextView) listViewItem.findViewById(vin.way.igor.depo.R.id.stop_name);
