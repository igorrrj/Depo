...
public class MyProvider extends AppWidgetProvider {
   ...
   static void updateWidget(Context context, AppWidgetManager appWidgetManager, SharedPreferences sp,
        ...
        RemoteViews rv = new RemoteViews(context.getPackageName(),
                vin.way.igor.depo.R.layout.widget);
        ...
        appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetId, vin.way.igor.depo.R.id.listView);
    ...
    static void setList(RemoteViews rv, Context context,  SharedPreferences sp,int appWidgetId) {
        ...
        rv.setRemoteAdapter(vin.way.igor.depo.R.id.listView, adapter);
    }
