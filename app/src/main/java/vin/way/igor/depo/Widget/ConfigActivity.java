...
public class ConfigActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(vin.way.igor.depo.R.layout.config);
    }

    public void onClick(View view) {
        int type = ((RadioGroup) findViewById(vin.way.igor.depo.R.id.typeGroup))
                .getCheckedRadioButtonId();
        String transport_type="Tram";
        switch (type)
        {
            case vin.way.igor.depo.R.id.radio_tram:
                transport_type="Tram";
                break;
            case vin.way.igor.depo.R.id.radio_bus:
