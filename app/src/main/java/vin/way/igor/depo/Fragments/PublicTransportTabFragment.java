...
public class PublicTransportTabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View x = inflater.inflate(vin.way.igor.depo.R.layout.public_transport_tab_layout, null);

        ((AppCompatActivity) getActivity()).getSupportActionBar().setElevation(0);

        tabLayout = (TabLayout) x.findViewById(vin.way.igor.depo.R.id.tabs);
        viewPager = (ViewPager) x.findViewById(vin.way.igor.depo.R.id.viewpager);

        error_text = (TextView) x.findViewById(vin.way.igor.depo.R.id.error_text);
        linearLayout = (LinearLayout) x.findViewById(vin.way.igor.depo.R.id.tab_liner);
