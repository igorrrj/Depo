...
import vin.way.igor.depo.Fragments.Liked_Transport_Fragment;
...
public class SelectedLikedTabActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vin.way.igor.depo.R.layout.selected_tab_layout);
    ...
    public void onBackPressed() {
      ...
      if(!ans){
            ...
            getIntent().putExtra("result", Liked_Transport_Fragment.DELETE);
      }
     else{
          getIntent().putExtra("result", Liked_Transport_Fragment.NOT_DELETE);
      }
